		  ...
		  <div className="bg-indigo-400 relative mx-auto flex-wrap flex items-center justify-between p-6 pt-0 lg:px-8">
			  <div className="container mx-auto md:w-1/2">
				  <div className="relative">
					  <svg aria-hidden="true" className="absolute top-[10px] left-[10px] md:w-5 md:h-5 h-7 w-7 text-gray-500 dark:text-gray-400" fill="none"
					  ...
					  />
					  <div onClick={ handleMicClick } className="absolute cursor-pointer top-[10px] right-[40px] md:right-[30px]">
						  <MicrophoneIcon className={ `md:h-5 md:w-5 h-7 w-7 ${isListening ? 'text-gray-400' : ''}`}/>
					  </div>
					  <button type="button" onClick={ handleClearSearch } className="absolute top-[16px] right-[10px] ">
						  <svg className="h-5 w-5 md:w-3 md:h-3 text-gray-500 dark:text-gray-400" viewBox="0 0 460.775 460.775" fill="currentColor">
